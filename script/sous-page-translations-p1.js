...
async function updateContent(language) {
    ...
    setTimeout(() => {
        ...
        document.querySelector('.p1-title1').textContent = polyglot.t('p1-title1');
        document.querySelector('.p1-subtitle1').textContent = polyglot.t('p1-subtitle1');
        document.querySelector('.p1-title2').textContent = polyglot.t('p1-title2');
        document.querySelector('.p1-subtitle2').textContent = polyglot.t('p1-subtitle2');
        document.querySelector('.p1-title3').textContent = polyglot.t('p1-title3');
        document.querySelector('.p1-subtitle3').textContent = polyglot.t('p1-subtitle3');
        document.querySelector('.p1-title4').textContent = polyglot.t('p1-title4');
        document.querySelector('.p1-subtitle4').textContent = polyglot.t('p1-subtitle4');
        document.querySelector('.p1-title5').textContent = polyglot.t('p1-title5');
        document.querySelector('.p1-subtitle5').textContent = polyglot.t('p1-subtitle5');
